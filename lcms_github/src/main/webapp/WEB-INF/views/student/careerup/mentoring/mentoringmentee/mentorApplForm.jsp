...
<form id="menteeInsertForm" method="post">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="senior" name="senior" value="${srNo }" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="senior" name="senior" value="${memName }" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="memNo" name="memNo" value="${hakbun }" readonly>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="menteeJob" name="menteeJob">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="menteeCom" name="menteeCom">
    </div>
  </div>
